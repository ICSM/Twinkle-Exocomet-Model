...
#Process to select nearest LDC based on stellar temperature
#Initially assume log g = 4.5 and z = 0.0, want to change that
#in future.
def get_ldc(tstar):
    ...
    ldc_data = ascii.read(direc+ldc_file,delimiter=';',comment='#',format='basic',fast_reader='False',guess='False')
